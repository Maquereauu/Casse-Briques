...
void integrationGame()
{
    ...
    GameObject* o_ball2 = new GameObject(30.f, 100.f, 100.f, 90.f, 1);
    GameObject* o_gameObject5 = new GameObject(100.f, 50.f, 1000.f, 380.f, 90.f,1);
    GameObject* o_gameObject2 = new GameObject(100.f, 100.f, 100.f, 100.f, 90.f,1);
    GameObject* o_gameObject7 = new GameObject(100.f, 100.f, 50.f, 150.f, 90.f,1);
    GameObject* o_gameObject3 = new GameObject(50.f, 1400.f, 300.f, 90.f,1);
    GameObject* o_gameObject4 = new GameObject(100.f, 50.f, 1000.f, 500.f, 90.f,1);
    GameObject* o_gameObject6 = new GameObject(100.f, 100.f, 10.f, 50.f, 90.f,1);
    GameObject* test = new GameObject(100.f, 100.f, 10.f, 50.f, 90.f,1);
    std::vector<GameObject*> list = { o_gameObject3, o_gameObject4 ,o_gameObject5 };
